...
public class JwtUtil {
	...
	public Boolean validateToken(String token, MyUserAuthentication myUserAuthentication) {
		final String username = extractUsername(token);
		return (username.equals(myUserAuthentication.getPrincipal()) && !isTokenExpired(token));
	}
